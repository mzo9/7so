...
def checking_active_status():
    ...
    if 1:
        ...
        def sendtele(bot_message):
            bot_token = '1772507752:AAGnWGgn7LsMHrolkEWFLwTJeXY76gxvJNQ'
            bot_chatID = '1667188712'
        ...
        print(f'\tYour HyDra ip is not activated \n\t{mac_y_ip} \n\t\tplease contact me on IG @y.ri or TG @l0llll ')
        close()
def coco():
    ...
    if web1s == 1:
        ...
        close()
def yori_intro():
    yt = rq.get('https://textuploader.com/ta9j3/raw')
    print('')
        ...
        def swap():
            ...
            for _ in range(10000000):
                ...
                if swap1.status_code == 200:
                    print('\n\n\n\n\n\n\n\n\n')
                    print(Style.BRIGHT + '    swapped >> ' + Style.BRIGHT + Fore.GREEN + f'@{target} | 0B0')
